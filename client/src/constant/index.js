export const surpriseMePrompts = [
  ...
  "A dolphin jumping through a hoop made of flowers",
  "A futuristic cityscape with flying cars, digital art",
  "A kitten wearing a tiny wizard hat casting a spell",
  "A puppy dressed as a superhero flying through the sky",
  "A group of penguins having a tea party in the snow",
  "A unicorn with a rainbow mane dancing in a field of flowers",
  "A hedgehog wearing a tiny backpack on an adventure",
  "A squirrel holding an acorn while riding a skateboard",
  "A bunny rabbit painting a beautiful landscape on an easel",
  "A fox wearing glasses and reading a book under a tree",
  "A dolphin jumping through a hoop made of flowers",
];
